...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  800266:	c7 04 24 a0 1a 80 00 	movl   $0x801aa0,(%esp)
  ...
  800284:	c7 04 24 ab 1a 80 00 	movl   $0x801aab,(%esp)
  ...
  80029a:	c7 04 24 bd 1a 80 00 	movl   $0x801abd,(%esp)
  ...
  8002b0:	c7 04 24 d0 1a 80 00 	movl   $0x801ad0,(%esp)
  ...
  8002c6:	c7 04 24 e3 1a 80 00 	movl   $0x801ae3,(%esp)
...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800306:	c7 04 24 f6 1a 80 00 	movl   $0x801af6,(%esp)
  ...
  80031f:	e8 7e 00 00 00       	call   8003a2 <vcprintf>
    cprintf("\n");
  800324:	c7 04 24 10 1b 80 00 	movl   $0x801b10,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  800356:	c7 04 24 12 1b 80 00 	movl   $0x801b12,(%esp)
  ...
  80036f:	e8 2e 00 00 00       	call   8003a2 <vcprintf>
    cprintf("\n");
  800374:	c7 04 24 10 1b 80 00 	movl   $0x801b10,(%esp)
...
exit(int error_code) {
  ...
  8008b1:	c7 04 24 2e 1b 80 00 	movl   $0x801b2e,(%esp)
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800be2:	05 a4 1d 80 00       	add    $0x801da4,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  800d46:	8b 04 85 c8 1d 80 00 	mov    0x801dc8(,%eax,4),%eax
  ...
  800e5f:	c7 44 24 0c be 1d 80 	movl   $0x801dbe,0xc(%esp)
  800e66:	00 
  ...
  800e92:	75 05                	jne    800e99 <vprintfmt+0x1c9>
                p = "(null)";
  800e94:	be c1 1d 80 00       	mov    $0x801dc1,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  8017ef:	e8 e9 eb ff ff       	call   8003dd <cprintf>
     sleep(SLEEP_TIME);
  8017f4:	c7 04 24 90 01 00 00 	movl   $0x190,(%esp)
  8017fb:	e8 4f f1 ff ff       	call   80094f <sleep>
  ...
  801817:	e8 04 fe ff ff       	call   801620 <memset>
     lab6_set_priority(TOTAL + 1);
  80181c:	c7 04 24 06 00 00 00 	movl   $0x6,(%esp)
  801823:	e8 14 f1 ff ff       	call   80093c <lab6_set_priority>
  ...
  801840:	00 00 00 00 
          if ((pids[i] = fork()) == 0) {
  801844:	e8 76 f0 ff ff       	call   8008bf <fork>
  ...
  801871:	e8 c6 f0 ff ff       	call   80093c <lab6_set_priority>
               acc[i] = 0;
  ...
  8018ca:	e8 93 f0 ff ff       	call   800962 <gettime_msec>
  ...
  8018e8:	e8 35 f0 ff ff       	call   800922 <getpid>
...
failed:
  ...
  801955:	e8 83 ea ff ff       	call   8003dd <cprintf>
  ...
  801992:	e8 51 ef ff ff       	call   8008e8 <waitpid>
         cprintf("main: pid %d, acc %d, time %d\n",pids[i],status[i],gettime_msec()); 
  801997:	e8 c6 ef ff ff       	call   800962 <gettime_msec>
  ...
  8019c5:	e8 13 ea ff ff       	call   8003dd <cprintf>
          }
     }
  ...
  8019dd:	e8 fb e9 ff ff       	call   8003dd <cprintf>
     cprintf("stride sched correct result:");
  8019e2:	c7 04 24 c5 1f 80 00 	movl   $0x801fc5,(%esp)
  8019e9:	e8 ef e9 ff ff       	call   8003dd <cprintf>
     for (i = 0; i < TOTAL; i ++)
  ...
  801a25:	e8 b3 e9 ff ff       	call   8003dd <cprintf>
         waitpid(pids[i],&status[i]);
         cprintf("main: pid %d, acc %d, time %d\n",pids[i],status[i],gettime_msec()); 
     }
     cprintf("main: wait pids over\n");
  ...
  801a3d:	e8 9b e9 ff ff       	call   8003dd <cprintf>
...
failed:
  ...
  801a66:	e8 a4 ee ff ff       	call   80090f <kill>
     cprintf("\n");
...
failed:
  ...
  801a8e:	e8 59 e8 ff ff       	call   8002ec <__panic>
}
