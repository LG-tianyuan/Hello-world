...
main(void) {
  ...
  8017f6:	e8 f1 ea ff ff       	call   8002ec <__panic>
...
main(void) {
  ...
  80186e:	e8 79 ea ff ff       	call   8002ec <__panic>
        }
    }
    for (i = 0; i < ARRAYSIZE; i ++) {
        bigarray[i] = i;
  ...
  801889:	e8 4f eb ff ff       	call   8003dd <cprintf>
    cprintf("testbss may pass.\n");
  80188e:	c7 04 24 07 1e 80 00 	movl   $0x801e07,(%esp)
  801895:	e8 43 eb ff ff       	call   8003dd <cprintf>
  ...
  8018bd:	e8 2a ea ff ff       	call   8002ec <__panic>
