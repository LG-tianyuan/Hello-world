...
static int safe_open(const char *path, int open_flags)
{
  ...
  8017bc:	e8 37 e9 ff ff       	call   8000f8 <open>
  ...
  8017da:	e8 e2 ec ff ff       	call   8004c1 <fprintf>
	assert(fd >= 0);
  ...
  801804:	e8 e3 ea ff ff       	call   8002ec <__panic>
	return fd;
...
static struct stat *safe_fstat(int fd)
{
  ...
  801823:	e8 60 e9 ff ff       	call   800188 <fstat>
  ...
  801850:	e8 97 ea ff ff       	call   8002ec <__panic>
	return stat;
...
static void safe_read(int fd, void *data, size_t len)
{
  ...
  801876:	e8 aa e8 ff ff       	call   800125 <read>
  ...
  8018a5:	e8 42 ea ff ff       	call   8002ec <__panic>
}
  8018aa:	c9                   	leave  
  8018ab:	c3                   	ret    
...
int main(void)
{
  ...
  8018ec:	e8 d0 eb ff ff       	call   8004c1 <fprintf>
	return 0;
