...
exit(int error_code) {
  ...
  8008b1:	c7 04 24 ee 18 80 00 	movl   $0x8018ee,(%esp)
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800be2:	05 64 1b 80 00       	add    $0x801b64,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  800d46:	8b 04 85 88 1b 80 00 	mov    0x801b88(,%eax,4),%eax
  ...
  800e5f:	c7 44 24 0c 7e 1b 80 	movl   $0x801b7e,0xc(%esp)
  800e66:	00 
  ...
  800e92:	75 05                	jne    800e99 <vprintfmt+0x1c9>
                p = "(null)";
  800e94:	be 81 1b 80 00       	mov    $0x801b81,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  8017c9:	e8 81 f1 ff ff       	call   80094f <sleep>
        exit(0xdead);
  8017ce:	c7 04 24 ad de 00 00 	movl   $0xdead,(%esp)
  8017d5:	e8 c6 f0 ff ff       	call   8008a0 <exit>
    }
    assert(pid > 0);
  ...
  801800:	e8 e7 ea ff ff       	call   8002ec <__panic>

    sleep(100);
  801805:	c7 04 24 64 00 00 00 	movl   $0x64,(%esp)
  80180c:	e8 3e f1 ff ff       	call   80094f <sleep>
    assert(kill(pid) == 0);
  801811:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801815:	89 04 24             	mov    %eax,(%esp)
  801818:	e8 f2 f0 ff ff       	call   80090f <kill>
  ...
  801840:	e8 a7 ea ff ff       	call   8002ec <__panic>
    cprintf("sleepkill pass.\n");
  801845:	c7 04 24 1d 1d 80 00 	movl   $0x801d1d,(%esp)
  80184c:	e8 8c eb ff ff       	call   8003dd <cprintf>
    return 0;
