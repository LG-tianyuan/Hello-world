...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  800266:	c7 04 24 40 18 80 00 	movl   $0x801840,(%esp)
  ...
  800284:	c7 04 24 4b 18 80 00 	movl   $0x80184b,(%esp)
  ...
  80029a:	c7 04 24 5d 18 80 00 	movl   $0x80185d,(%esp)
  ...
  8002b0:	c7 04 24 70 18 80 00 	movl   $0x801870,(%esp)
  ...
  8002c6:	c7 04 24 83 18 80 00 	movl   $0x801883,(%esp)
...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800306:	c7 04 24 96 18 80 00 	movl   $0x801896,(%esp)
  ...
  80031f:	e8 7e 00 00 00       	call   8003a2 <vcprintf>
    cprintf("\n");
  800324:	c7 04 24 b0 18 80 00 	movl   $0x8018b0,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  800356:	c7 04 24 b2 18 80 00 	movl   $0x8018b2,(%esp)
  ...
  80036f:	e8 2e 00 00 00       	call   8003a2 <vcprintf>
    cprintf("\n");
  800374:	c7 04 24 b0 18 80 00 	movl   $0x8018b0,(%esp)
...
exit(int error_code) {
  ...
  8008b1:	c7 04 24 ce 18 80 00 	movl   $0x8018ce,(%esp)
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800be2:	05 44 1b 80 00       	add    $0x801b44,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  800d46:	8b 04 85 68 1b 80 00 	mov    0x801b68(,%eax,4),%eax
  ...
  800e5f:	c7 44 24 0c 5e 1b 80 	movl   $0x801b5e,0xc(%esp)
  800e66:	00 
  ...
  800e92:	75 05                	jne    800e99 <vprintfmt+0x1c9>
                p = "(null)";
  800e94:	be 61 1b 80 00       	mov    $0x801b61,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  8017ee:	e8 ea eb ff ff       	call   8003dd <cprintf>
