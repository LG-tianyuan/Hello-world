...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  800266:	c7 04 24 60 1b 80 00 	movl   $0x801b60,(%esp)
  ...
  800284:	c7 04 24 6b 1b 80 00 	movl   $0x801b6b,(%esp)
  ...
  80029a:	c7 04 24 7d 1b 80 00 	movl   $0x801b7d,(%esp)
  ...
  8002b0:	c7 04 24 90 1b 80 00 	movl   $0x801b90,(%esp)
  ...
  8002c6:	c7 04 24 a3 1b 80 00 	movl   $0x801ba3,(%esp)
...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800306:	c7 04 24 b6 1b 80 00 	movl   $0x801bb6,(%esp)
  ...
  80031f:	e8 7e 00 00 00       	call   8003a2 <vcprintf>
    cprintf("\n");
  800324:	c7 04 24 d0 1b 80 00 	movl   $0x801bd0,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  800356:	c7 04 24 d2 1b 80 00 	movl   $0x801bd2,(%esp)
  ...
  80036f:	e8 2e 00 00 00       	call   8003a2 <vcprintf>
    cprintf("\n");
  800374:	c7 04 24 d0 1b 80 00 	movl   $0x801bd0,(%esp)
...
lock_fork(void) {
  ...
  80087b:	83 ec 18             	sub    $0x18,%esp
    lock(&fork_lock);
  80087e:	c7 04 24 40 30 80 00 	movl   $0x803040,(%esp)
...
unlock_fork(void) {
  ...
  80088f:	83 ec 04             	sub    $0x4,%esp
    unlock(&fork_lock);
  800892:	c7 04 24 40 30 80 00 	movl   $0x803040,(%esp)
...
exit(int error_code) {
  ...
  8008b1:	c7 04 24 ee 1b 80 00 	movl   $0x801bee,(%esp)
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800be2:	05 64 1e 80 00       	add    $0x801e64,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  800d46:	8b 04 85 88 1e 80 00 	mov    0x801e88(,%eax,4),%eax
  ...
  800e5f:	c7 44 24 0c 7e 1e 80 	movl   $0x801e7e,0xc(%esp)
  800e66:	00 
  ...
  800e92:	75 05                	jne    800e99 <vprintfmt+0x1c9>
                p = "(null)";
  800e94:	be 81 1e 80 00       	mov    $0x801e81,%esi
            }
            if (width > 0 && padc != '-') {
...
getstat(const char *name, struct stat *stat) {
  ...
  80182c:	e8 c7 e8 ff ff       	call   8000f8 <open>
...
lsstat(struct stat *stat, const char *filename) {
  ...
  80188d:	e8 2f ec ff ff       	call   8004c1 <fprintf>
  ...
  8018ab:	e8 11 ec ff ff       	call   8004c1 <fprintf>
  ...
  8018c9:	e8 f3 eb ff ff       	call   8004c1 <fprintf>
  ...
  8018e7:	e8 d5 eb ff ff       	call   8004c1 <fprintf>
    printf("   %s\n", filename);
  ...
  801902:	e8 ba eb ff ff       	call   8004c1 <fprintf>
}
  801907:	c9                   	leave  
  801908:	c3                   	ret    
...
lsdir(const char *path) {
  ...
  80191c:	e8 ff e6 ff ff       	call   800020 <opendir>
...
failed:
  ...
  801958:	e8 6c e7 ff ff       	call   8000c9 <closedir>
    return ret;
  ...
  80197d:	e8 17 e7 ff ff       	call   800099 <readdir>
  ...
  80199a:	e8 22 eb ff ff       	call   8004c1 <fprintf>
    closedir(dirp);
  80199f:	8b 45 f0             	mov    -0x10(%ebp),%eax
  8019a2:	89 04 24             	mov    %eax,(%esp)
  8019a5:	e8 1f e7 ff ff       	call   8000c9 <closedir>
    return 0;
...
ls(const char *path) {
  ...
  801a64:	e8 58 ea ff ff       	call   8004c1 <fprintf>
  ...
  801a82:	e8 3a ea ff ff       	call   8004c1 <fprintf>
  ...
  801aa0:	e8 1c ea ff ff       	call   8004c1 <fprintf>
    printf(" %d(bytes) : @'%s'\n", stat->st_size, path);
  ...
  801ac5:	e8 f7 e9 ff ff       	call   8004c1 <fprintf>
