...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  800266:	c7 04 24 a0 1b 80 00 	movl   $0x801ba0,(%esp)
  ...
  800284:	c7 04 24 ab 1b 80 00 	movl   $0x801bab,(%esp)
  ...
  80029a:	c7 04 24 bd 1b 80 00 	movl   $0x801bbd,(%esp)
  ...
  8002b0:	c7 04 24 d0 1b 80 00 	movl   $0x801bd0,(%esp)
  ...
  8002c6:	c7 04 24 e3 1b 80 00 	movl   $0x801be3,(%esp)
...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800306:	c7 04 24 f6 1b 80 00 	movl   $0x801bf6,(%esp)
  ...
  80031f:	e8 7e 00 00 00       	call   8003a2 <vcprintf>
    cprintf("\n");
  800324:	c7 04 24 10 1c 80 00 	movl   $0x801c10,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  800356:	c7 04 24 12 1c 80 00 	movl   $0x801c12,(%esp)
  ...
  80036f:	e8 2e 00 00 00       	call   8003a2 <vcprintf>
    cprintf("\n");
  800374:	c7 04 24 10 1c 80 00 	movl   $0x801c10,(%esp)
...
exit(int error_code) {
  ...
  8008b1:	c7 04 24 2e 1c 80 00 	movl   $0x801c2e,(%esp)
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800be2:	05 a4 1e 80 00       	add    $0x801ea4,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  800d46:	8b 04 85 c8 1e 80 00 	mov    0x801ec8(,%eax,4),%eax
  ...
  800e5f:	c7 44 24 0c be 1e 80 	movl   $0x801ebe,0xc(%esp)
  800e66:	00 
  ...
  800e92:	75 05                	jne    800e99 <vprintfmt+0x1c9>
                p = "(null)";
  800e94:	be c1 1e 80 00       	mov    $0x801ec1,%esi
            }
            if (width > 0 && padc != '-') {
...
work(unsigned int times) {
  ...
  80182b:	7c 93                	jl     8017c0 <work+0x17>
    ...
    yield();
  80182d:	e8 d0 f0 ff ff       	call   800902 <yield>

    cprintf("pid %d is running (%d times)!.\n", getpid(), times);
  801832:	e8 eb f0 ff ff       	call   800922 <getpid>
  ...
  801849:	e8 8f eb ff ff       	call   8003dd <cprintf>
  ...
  8019ba:	0f 85 93 fe ff ff    	jne    801853 <work+0xaa>
    ...
    cprintf("pid %d done!.\n", getpid());
  8019c0:	e8 5d ef ff ff       	call   800922 <getpid>
  8019c5:	89 44 24 04          	mov    %eax,0x4(%esp)
  8019c9:	c7 04 24 40 20 80 00 	movl   $0x802040,(%esp)
  8019d0:	e8 08 ea ff ff       	call   8003dd <cprintf>
    exit(0);
  8019d5:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  8019dc:	e8 bf ee ff ff       	call   8008a0 <exit>
...
main(void) {
  ...
  801a57:	e8 c4 fb ff ff       	call   801620 <memset>
  ...
  801a63:	eb 70                	jmp    801ad5 <main+0xf4>
        if ((pids[i] = fork()) == 0) {
  801a65:	e8 55 ee ff ff       	call   8008bf <fork>
  ...
  801a8a:	e8 23 f8 ff ff       	call   8012b2 <srand>
            int times = (((unsigned int)rand()) % total);
  801a8f:	e8 5e f7 ff ff       	call   8011f2 <rand>
...
main(void) {
  ...
  801b20:	e8 b8 e8 ff ff       	call   8003dd <cprintf>
    return 0;
...
failed:
  ...
  801b50:	e8 ba ed ff ff       	call   80090f <kill>
...
failed:
  ...
  801b7a:	e8 6d e7 ff ff       	call   8002ec <__panic>
}
