...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  800266:	c7 04 24 e0 17 80 00 	movl   $0x8017e0,(%esp)
  ...
  800284:	c7 04 24 eb 17 80 00 	movl   $0x8017eb,(%esp)
  ...
  80029a:	c7 04 24 fd 17 80 00 	movl   $0x8017fd,(%esp)
  ...
  8002b0:	c7 04 24 10 18 80 00 	movl   $0x801810,(%esp)
  ...
  8002c6:	c7 04 24 23 18 80 00 	movl   $0x801823,(%esp)
...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800306:	c7 04 24 36 18 80 00 	movl   $0x801836,(%esp)
  ...
  80031f:	e8 7e 00 00 00       	call   8003a2 <vcprintf>
    cprintf("\n");
  800324:	c7 04 24 50 18 80 00 	movl   $0x801850,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  800356:	c7 04 24 52 18 80 00 	movl   $0x801852,(%esp)
  ...
  80036f:	e8 2e 00 00 00       	call   8003a2 <vcprintf>
    cprintf("\n");
  800374:	c7 04 24 50 18 80 00 	movl   $0x801850,(%esp)
...
exit(int error_code) {
  ...
  8008b1:	c7 04 24 6e 18 80 00 	movl   $0x80186e,(%esp)
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800be2:	05 e4 1a 80 00       	add    $0x801ae4,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  800d46:	8b 04 85 08 1b 80 00 	mov    0x801b08(,%eax,4),%eax
  ...
  800e5f:	c7 44 24 0c fe 1a 80 	movl   $0x801afe,0xc(%esp)
  800e66:	00 
  ...
  800e92:	75 05                	jne    800e99 <vprintfmt+0x1c9>
                p = "(null)";
  800e94:	be 01 1b 80 00       	mov    $0x801b01,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  8017c2:	e8 16 ec ff ff       	call   8003dd <cprintf>
    print_pgdir();
  8017c7:	e8 63 f1 ff ff       	call   80092f <print_pgdir>
    cprintf("pgdir pass.\n");
  8017cc:	c7 04 24 77 1c 80 00 	movl   $0x801c77,(%esp)
  8017d3:	e8 05 ec ff ff       	call   8003dd <cprintf>
    return 0;
