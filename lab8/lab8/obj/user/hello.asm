...
exit(int error_code) {
  ...
  8008b1:	c7 04 24 8e 18 80 00 	movl   $0x80188e,(%esp)
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800be2:	05 04 1b 80 00       	add    $0x801b04,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  800d46:	8b 04 85 28 1b 80 00 	mov    0x801b28(,%eax,4),%eax
  ...
  800e5f:	c7 44 24 0c 1e 1b 80 	movl   $0x801b1e,0xc(%esp)
  800e66:	00 
  ...
  800e92:	75 05                	jne    800e99 <vprintfmt+0x1c9>
                p = "(null)";
  800e94:	be 21 1b 80 00       	mov    $0x801b21,%esi
            }
            if (width > 0 && padc != '-') {
