...
exit(int error_code) {
  ...
  8008b1:	c7 04 24 8e 19 80 00 	movl   $0x80198e,(%esp)
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800be2:	05 04 1c 80 00       	add    $0x801c04,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  800d46:	8b 04 85 28 1c 80 00 	mov    0x801c28(,%eax,4),%eax
  ...
  800e5f:	c7 44 24 0c 1e 1c 80 	movl   $0x801c1e,0xc(%esp)
  800e66:	00 
  ...
  800e92:	75 05                	jne    800e99 <vprintfmt+0x1c9>
                p = "(null)";
  800e94:	be 21 1c 80 00       	mov    $0x801c21,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  8017af:	83 ec 20             	sub    $0x20,%esp
    int pid, exit_code;
    if ((pid = fork()) == 0) {
  8017b2:	e8 08 f1 ff ff       	call   8008bf <fork>
  ...
  8017c9:	e8 0f ec ff ff       	call   8003dd <cprintf>
        int i;
        for (i = 0; i < 10; i ++) {
  ...
  8017d6:	eb 0a                	jmp    8017e2 <main+0x39>
            yield();
  8017d8:	e8 25 f1 ff ff       	call   800902 <yield>
main(void) {
    int pid, exit_code;
    if ((pid = fork()) == 0) {
        cprintf("fork ok.\n");
  ...
  8017f0:	e8 ab f0 ff ff       	call   8008a0 <exit>
    }
    assert(pid > 0);
  ...
  801857:	e8 90 ea ff ff       	call   8002ec <__panic>
  ...
  80186b:	e8 78 f0 ff ff       	call   8008e8 <waitpid>
  ...
  801893:	e8 54 ea ff ff       	call   8002ec <__panic>
  ...
  8018a7:	e8 3c f0 ff ff       	call   8008e8 <waitpid>
  ...
  8018da:	e8 0d ea ff ff       	call   8002ec <__panic>
    cprintf("badarg pass.\n");
  8018df:	c7 04 24 29 1e 80 00 	movl   $0x801e29,(%esp)
  8018e6:	e8 f2 ea ff ff       	call   8003dd <cprintf>
    return 0;
