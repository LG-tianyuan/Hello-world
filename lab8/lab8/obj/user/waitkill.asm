...
exit(int error_code) {
  ...
  8008b1:	c7 04 24 ce 19 80 00 	movl   $0x8019ce,(%esp)
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800be2:	05 44 1c 80 00       	add    $0x801c44,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  800d46:	8b 04 85 68 1c 80 00 	mov    0x801c68(,%eax,4),%eax
  ...
  800e5f:	c7 44 24 0c 5e 1c 80 	movl   $0x801c5e,0xc(%esp)
  800e66:	00 
  ...
  800e92:	75 05                	jne    800e99 <vprintfmt+0x1c9>
                p = "(null)";
  800e94:	be 61 1c 80 00       	mov    $0x801c61,%esi
            }
            if (width > 0 && padc != '-') {
...
do_yield(void) {
  ...
  8017ac:	83 ec 08             	sub    $0x8,%esp
    yield();
  8017af:	e8 4e f1 ff ff       	call   800902 <yield>
    yield();
  8017b4:	e8 49 f1 ff ff       	call   800902 <yield>
    yield();
  8017b9:	e8 44 f1 ff ff       	call   800902 <yield>
    yield();
  8017be:	e8 3f f1 ff ff       	call   800902 <yield>
    yield();
  8017c3:	e8 3a f1 ff ff       	call   800902 <yield>
    yield();
  8017c8:	e8 35 f1 ff ff       	call   800902 <yield>
}
  8017cd:	c9                   	leave  
  8017ce:	c3                   	ret    
...
loop(void) {
  ...
  8017dc:	e8 fc eb ff ff       	call   8003dd <cprintf>
    while (1);
...
work(void) {
  ...
  801802:	e8 08 f1 ff ff       	call   80090f <kill>
  ...
  801824:	e8 e6 f0 ff ff       	call   80090f <kill>
  ...
  801840:	e8 5b f0 ff ff       	call   8008a0 <exit>
        }
    }
    exit(-1);
  801845:	c7 04 24 ff ff ff ff 	movl   $0xffffffff,(%esp)
  80184c:	e8 4f f0 ff ff       	call   8008a0 <exit>
...
main(void) {
  ...
  801857:	83 ec 10             	sub    $0x10,%esp
    parent = getpid();
  80185a:	e8 c3 f0 ff ff       	call   800922 <getpid>
  80185f:	a3 48 21 80 00       	mov    %eax,0x802148
    if ((pid1 = fork()) == 0) {
  801864:	e8 56 f0 ff ff       	call   8008bf <fork>
  ...
  8018a4:	e8 43 ea ff ff       	call   8002ec <__panic>

    if ((pid2 = fork()) == 0) {
  8018a9:	e8 11 f0 ff ff       	call   8008bf <fork>
  ...
  80190b:	e8 dc e9 ff ff       	call   8002ec <__panic>
    }
    else {
        kill(pid1);
  801910:	a1 50 21 80 00       	mov    0x802150,%eax
  801915:	89 04 24             	mov    %eax,(%esp)
  801918:	e8 f2 ef ff ff       	call   80090f <kill>
    }
    panic("FAIL: T.T\n");
  ...
  801934:	e8 b3 e9 ff ff       	call   8002ec <__panic>
