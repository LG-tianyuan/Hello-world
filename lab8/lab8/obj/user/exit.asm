...
exit(int error_code) {
  ...
  8008b1:	c7 04 24 ae 19 80 00 	movl   $0x8019ae,(%esp)
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800be2:	05 24 1c 80 00       	add    $0x801c24,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  800d46:	8b 04 85 48 1c 80 00 	mov    0x801c48(,%eax,4),%eax
  ...
  800e5f:	c7 44 24 0c 3e 1c 80 	movl   $0x801c3e,0xc(%esp)
  800e66:	00 
  ...
  800e92:	75 05                	jne    800e99 <vprintfmt+0x1c9>
                p = "(null)";
  800e94:	be 41 1c 80 00       	mov    $0x801c41,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  8017d5:	e8 03 ec ff ff       	call   8003dd <cprintf>
        yield();
  8017da:	e8 23 f1 ff ff       	call   800902 <yield>
        yield();
  8017df:	e8 1e f1 ff ff       	call   800902 <yield>
        yield();
  8017e4:	e8 19 f1 ff ff       	call   800902 <yield>
        yield();
  8017e9:	e8 14 f1 ff ff       	call   800902 <yield>
        yield();
  8017ee:	e8 0f f1 ff ff       	call   800902 <yield>
        yield();
  8017f3:	e8 0a f1 ff ff       	call   800902 <yield>
        yield();
  8017f8:	e8 05 f1 ff ff       	call   800902 <yield>
        exit(magic);
  8017fd:	a1 10 20 80 00       	mov    0x802010,%eax
  801802:	89 04 24             	mov    %eax,(%esp)
  801805:	e8 96 f0 ff ff       	call   8008a0 <exit>
    }
    else {
  ...
  801819:	e8 bf eb ff ff       	call   8003dd <cprintf>
    }
    assert(pid > 0);
  ...
  801844:	e8 a3 ea ff ff       	call   8002ec <__panic>
    cprintf("I am the parent, waiting now..\n");
  801849:	c7 04 24 24 1e 80 00 	movl   $0x801e24,(%esp)
  801850:	e8 88 eb ff ff       	call   8003dd <cprintf>
  ...
  801864:	e8 7f f0 ff ff       	call   8008e8 <waitpid>
  ...
  801899:	e8 4e ea ff ff       	call   8002ec <__panic>
  ...
  8018ad:	e8 36 f0 ff ff       	call   8008e8 <waitpid>
  8018b2:	85 c0                	test   %eax,%eax
  8018b4:	74 09                	je     8018bf <main+0x116>
  8018b6:	e8 11 f0 ff ff       	call   8008cc <wait>
