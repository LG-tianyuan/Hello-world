...
exit(int error_code) {
  ...
  8008b1:	c7 04 24 6e 19 80 00 	movl   $0x80196e,(%esp)
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800be2:	05 e4 1b 80 00       	add    $0x801be4,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  800d46:	8b 04 85 08 1c 80 00 	mov    0x801c08(,%eax,4),%eax
  ...
  800e5f:	c7 44 24 0c fe 1b 80 	movl   $0x801bfe,0xc(%esp)
  800e66:	00 
  ...
  800e92:	75 05                	jne    800e99 <vprintfmt+0x1c9>
                p = "(null)";
  800e94:	be 01 1c 80 00       	mov    $0x801c01,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  8017ba:	eb 60                	jmp    80181c <main+0x73>
        if ((pid = fork()) == 0) {
  8017bc:	e8 fe f0 ff ff       	call   8008bf <fork>
  ...
  8017e7:	e8 b4 f0 ff ff       	call   8008a0 <exit>
        }
        assert(pid > 0);
  ...
  801812:	e8 d5 ea ff ff       	call   8002ec <__panic>
const int max_child = 32;
...
main(void) {
  ...
  801851:	e8 96 ea ff ff       	call   8002ec <__panic>
    }

    for (; n > 0; n --) {
  801856:	eb 2a                	jmp    801882 <main+0xd9>
        if (wait() != 0) {
  801858:	e8 6f f0 ff ff       	call   8008cc <wait>
  ...
  801878:	e8 6f ea ff ff       	call   8002ec <__panic>
  ...
  801887:	7f cf                	jg     801858 <main+0xaf>
    ...
    if (wait() == 0) {
  801889:	e8 3e f0 ff ff       	call   8008cc <wait>
  ...
  8018a9:	e8 3e ea ff ff       	call   8002ec <__panic>
    }

    cprintf("forktest pass.\n");
  8018ae:	c7 04 24 e7 1d 80 00 	movl   $0x801de7,(%esp)
  8018b5:	e8 23 eb ff ff       	call   8003dd <cprintf>
    return 0;
