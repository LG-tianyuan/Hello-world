...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  800266:	c7 04 24 a0 18 80 00 	movl   $0x8018a0,(%esp)
  ...
  800284:	c7 04 24 ab 18 80 00 	movl   $0x8018ab,(%esp)
  ...
  80029a:	c7 04 24 bd 18 80 00 	movl   $0x8018bd,(%esp)
  ...
  8002b0:	c7 04 24 d0 18 80 00 	movl   $0x8018d0,(%esp)
  ...
  8002c6:	c7 04 24 e3 18 80 00 	movl   $0x8018e3,(%esp)
...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800306:	c7 04 24 f6 18 80 00 	movl   $0x8018f6,(%esp)
  ...
  80031f:	e8 7e 00 00 00       	call   8003a2 <vcprintf>
    cprintf("\n");
  800324:	c7 04 24 10 19 80 00 	movl   $0x801910,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  800356:	c7 04 24 12 19 80 00 	movl   $0x801912,(%esp)
  ...
  80036f:	e8 2e 00 00 00       	call   8003a2 <vcprintf>
    cprintf("\n");
  800374:	c7 04 24 10 19 80 00 	movl   $0x801910,(%esp)
...
exit(int error_code) {
  ...
  8008b1:	c7 04 24 2e 19 80 00 	movl   $0x80192e,(%esp)
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800be2:	05 a4 1b 80 00       	add    $0x801ba4,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  800d46:	8b 04 85 c8 1b 80 00 	mov    0x801bc8(,%eax,4),%eax
  ...
  800e5f:	c7 44 24 0c be 1b 80 	movl   $0x801bbe,0xc(%esp)
  800e66:	00 
  ...
  800e92:	75 05                	jne    800e99 <vprintfmt+0x1c9>
                p = "(null)";
  800e94:	be c1 1b 80 00       	mov    $0x801bc1,%esi
            }
            if (width > 0 && padc != '-') {
...
sleepy(int pid) {
  ...
  8017c5:	e8 85 f1 ff ff       	call   80094f <sleep>
  ...
  8017e2:	e8 f6 eb ff ff       	call   8003dd <cprintf>
#include <ulib.h>
...
sleepy(int pid) {
  ...
  8017f8:	e8 a3 f0 ff ff       	call   8008a0 <exit>
...
main(void) {
  ...
  801806:	e8 57 f1 ff ff       	call   800962 <gettime_msec>
  80180b:	89 44 24 1c          	mov    %eax,0x1c(%esp)
    int pid1, exit_code;

    if ((pid1 = fork()) == 0) {
  80180f:	e8 ab f0 ff ff       	call   8008bf <fork>
  ...
  80183a:	e8 a9 f0 ff ff       	call   8008e8 <waitpid>
